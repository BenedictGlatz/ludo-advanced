...
- **Rejected:** *omitting it*, which would have been tidier — it has no rules, so there is nothing to
  specify. But issue #35 is titled *Game HUD & Resource Display* and the Sprint 2 plan lists the
