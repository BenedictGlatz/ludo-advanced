...
`00-Meta/Project-Management/Online-Multiplayer-Plan.md` § "How starting a game works".
...
| File | What |
| --- | --- |
| `01-Design/Handoff/19-spec-online-lobby.md` | The spec. D116 to D122, one answer each, each with its reason and its named rejected alternative, following the five-section template in `01-Design/README.md` |
