...
runs are in `docs/documentation/notes/09-source-code-overview.md`.
...
`docs/documentation/notes/01-requirements-and-goals.md`.
...
| --- | --- | --- |
| ~~`design/handoff/04-spec-hud-menus-and-handover.md`~~ | D35 to D42 | **Delivered 2026-09-01** |
| `design/handoff/06-spec-pawn-mark.md` | D48 to D50, closing D16 | [06-brief](06-brief-pawn-mark.md), **first** |
| `design/handoff/05-spec-dice-pool-overlay.md` | D43 to D47 | [05-brief](05-brief-dice-pool-overlay.md), second |
