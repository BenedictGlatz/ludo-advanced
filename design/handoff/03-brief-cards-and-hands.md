...
2. **The card set is decided.** The Product Owner chose all 29 cards from the card artwork canvas in
   `design/handoff/card-art-canvas/Card Art.dc.html`, artboards `6a` and `4a`, plus
...
Screen ids from [obligations-book.md](../../docs/project-management/obligations-book.md) § 2.2:
...
`docs/documentation/notes/04-frontend-building-blocks.md` already records as a rule violation
...
All taken from [game-design-document.md](../../docs/project-management/game-design-document.md)
...
| File | What |
| --- | --- |
| `design/handoff/03-spec-cards-and-hands.md` | The spec, five sections per `design/README.md` |
...
Repeated from `design/README.md` so the spec can be checked against them without leaving this
file:
