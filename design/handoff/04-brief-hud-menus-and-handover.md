...
`card-art-canvas/Card Art.dc.html` into `src/ui/art/`. The markup is the artboard's own,
...
FR-36 in [requirements-specification.md](../../docs/project-management/requirements-specification.md):
...
| File | What |
| --- | --- |
| `design/handoff/04-spec-hud-menus-and-handover.md` | The spec, five sections per [README.md](../README.md) |
