...
| File | What it is |
| --- | --- |
| `design/handoff/18-spec-skill-card-animations.md` | The spec. Five sections per the README, one answer per decision with its reason **and its rejected alternatives**, and D107's 29-row table |
