...
[obligations-book.md](../../docs/project-management/obligations-book.md), plus the foundations
...
[game-design-document.md](../../docs/project-management/game-design-document.md), so that the
...
| File | Contains |
| --- | --- |
| `design/handoff/01-spec-foundations-and-board.md` | The five-section spec of [../README.md](../README.md). D1 to D9 each answered with a reason and a rejected alternative. |
...
| `design/assets/` | Any exported image or SVG, and only if one is genuinely needed. |

The three CSS files land in `src/ui/styles/` and not in `design/`, because they are production
