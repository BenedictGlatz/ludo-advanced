...
| `design/handoff/06-spec-pawn-mark.md` | New, this file | n/a |
...
package next to the handoff 05 answer rather than in `design/handoff/`. Nothing to delete after the
review.
...
in `docs/documentation/notes/01-requirements-and-goals.md` next to NFR-12, where the next person
