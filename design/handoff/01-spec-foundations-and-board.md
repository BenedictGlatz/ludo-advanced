...
[game-design-document.md](../../docs/project-management/game-design-document.md) instead, which
...
No asset was needed, so `design/assets/` stays empty. Both mechanical checks pass: the largest
