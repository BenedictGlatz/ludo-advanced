...
Numbers from [game-design-document.md](../../docs/project-management/game-design-document.md) § 5.
Never invented here.
...
| File | What |
| --- | --- |
| `design/handoff/05-spec-dice-pool-overlay.md` | The five spec sections, one answer per open decision, each with its reason and its rejected alternatives |
