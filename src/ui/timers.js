 ...
 * interval as well, and `card-controls.js` owns that, because how often a number on screen is redrawn
 * is a presentation question and this file has no opinion on it.
 *
 * It is also no longer where the durations live. Every "how long" function moved to
 * [holds.js](holds.js) on 2026-09-06, when design spec 18's cast hold would have been the sixth one and
 * would have pushed this file past NFR-02's 300 lines. The seam is the one the old header already
 * named: **the loop decides *that* it waits, `holds.js` decides *how long*, and this decides nothing at
 * all except how to cancel.**
 */
