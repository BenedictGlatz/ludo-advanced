...
/**
 * `boardOf` and `seatProgress` live in `selectors.js` since issue #93 and are re-exported from here, so
 * no importer changed. This file was at its 300-line limit; the two selectors read the state and write
 * nothing, which is the seam the header's lifetime table does not cover and the one worth cutting at.
 */
export { boardOf, seatProgress } from "./selectors.js";
