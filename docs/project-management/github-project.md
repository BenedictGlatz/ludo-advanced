...
> decides that the role table of [one-pager.md](one-pager.md) holds instead: Fabian Gemming is
...
The running record moved to [docs/documentation/](../documentation/README.md) on 2026-08-06.
...
- Chapter notes for the final report: [documentation/README.md](../documentation/README.md)