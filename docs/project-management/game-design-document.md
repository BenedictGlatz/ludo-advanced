...
([01-spec-foundations-and-board.md](../../design/handoff/01-spec-foundations-and-board.md), D3a)
...
> the seeds taught, recorded in `docs/documentation/project-journal.md`: a conclusion written down
...
> (`design/handoff/card-art-canvas/Card Art.dc.html`, artboards `6a` and `4a`). The
...
`design/handoff/06-spec-pawn-mark.md`, D48 to D50.
