...
[one-pager.md](one-pager.md) and the project journal: not on general opinions about the
...
| Time effort (fits the sprint plan) | 25 % | Fixed timeline: 3 sprints à 2 weeks plus a buffer sprint (~8 weeks total, see [github-project.md](github-project.md)). No calendar slack to recover from an underestimate. |
