...
[risk-analysis.md](risk-analysis.md). This document is the one that has to **decide** things,
...
| --- | --- | --- |
| The board has no buffer sprint, the written plan has one | [sprint-log.md](../documentation/sprint-log.md), [feasibility-study.md](feasibility-study.md), [one-pager.md](one-pager.md) | Section 2.2 |
| Board Sprint 3 is 1½ weeks, not 2 | same | Section 2.2 |
| Two role tables disagree on whether a Scrum Master exists | [documentation/README.md](../documentation/README.md), [notes/02-project-management.md](../documentation/notes/02-project-management.md) | Section 3.1 |
...
- **Add a fifth sprint to the board after 2026-09-17.** Rejected because no date after 2026-09-17 is
  ...
  [documentation/README.md](../documentation/README.md)). Planning past the last date anyone wrote down would
...
**Decided: the role table of [one-pager.md](one-pager.md) holds. Fabian Gemming is Product
Owner, Lars Bolender and Benedict Glatz are Scrum Members who also carry the Scrum Master work. The
Developer A/B/C table in [github-project.md](github-project.md) is superseded.**
...
[risk-analysis.md](risk-analysis.md) holds 16 rated risks with a mitigation each. Restating
...
[risk-analysis.md](risk-analysis.md). A register that announces its own trigger in advance and
...
[risk-analysis.md](risk-analysis.md) on 2026-08-22** rather than left here, because a risk that
...
- **It does not resolve the resource and energy system.** Section 6.7 of the game design document
  ...
  [github-project.md](github-project.md) still says otherwise and nobody has edited it.
