...
- **Source:** [one-pager.md](one-pager.md) sections *Objective*, *Beginning*, *Eliminating
...
- **Source:** [one-pager.md](one-pager.md) *Turn* and *Dice Card Pool*; backlog epic #37 with
  sub-issues #30, #31.
...
- **Source:** [one-pager.md](one-pager.md) *Skill Card Pool*; [CLAUDE.md](../../CLAUDE.md)
...
- **Undecided, not out of scope:** the **Resource/Energy System** appears in the Sprint 2 task list
  in [github-project.md](github-project.md) but in neither the one-pager, the README, nor any
...
- **Negative finding:** **no deployment target has been decided and no CI/CD pipeline exists.** Both
  are listed as open questions in [documentation/README.md](../documentation/README.md). Until one is chosen,
...
- **Source:** derived, not quoted. This is the reading of the design intent stated in
  [one-pager.md](one-pager.md) ("more options than just rolling dice") together with the
  external-playtesting requirement in [github-project.md](github-project.md).
