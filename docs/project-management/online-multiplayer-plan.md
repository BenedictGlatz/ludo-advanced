...
| CLAUDE.md: a new screen is Claude Design's job | The lobby is a new screen | write a brief in `design/handoff/00-open-requests.md`, ship a plain version on existing overlay patterns and tokens, record the exception in the journal |
...
- `design/handoff/00-open-requests.md`: brief for the lobby screen look.
