...
- ~~How the board is drawn: SVG, a CSS grid or `<canvas>`.~~ **Decided 2026-08-29: real DOM elements
  ...
  contract, written into `design/handoff/01-brief-foundations-and-board.md`, which names the exact
...
- Screen resolution and asset formats. They were Sprint 0 scope in
  [github-project.md](github-project.md) and were never agreed; see the Sprint 0 divergence in
...
- ~~**No design specification exists.**~~ **Closed on 2026-08-30.** Design handoff 01 landed under
  ...
  [design/handoff/01-spec-foundations-and-board.md](../../design/handoff/01-spec-foundations-and-board.md),
