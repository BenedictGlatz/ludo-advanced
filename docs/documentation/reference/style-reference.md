...
10. **Keep the AI index current.** Every prompt goes to `docs/ai-prompts/<user>/YYYY-MM-DD.json`
    with the right `topic`; `notes/13-ai-index.md` is generated from it and never hand-maintained.
11. **The 300-line file limit does not apply under `docs/documentation/`.** A chapter may be long
