...
- **Sprint plan inconsistency:** Sprint 1 in
  [github-project.md](../../project-management/github-project.md) plans a "standard 1–6 dice
...
[one-pager.md](../../project-management/one-pager.md) was the project's first document and its
...
- Energy/resource system is listed in the Sprint 2 plan
  ([github-project.md](../../project-management/github-project.md)) but appears in neither the
