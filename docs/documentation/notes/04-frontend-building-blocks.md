...
| The reasoning behind it | `design/handoff/` | "Why does it look like that" has to be findable without reading a stylesheet, six weeks later, by whoever writes the report. |

- **`design/` is a new top-level folder, committed to git**, sitting next to `docs`. It holds a
...
[01-spec-foundations-and-board.md](../../../design/handoff/01-spec-foundations-and-board.md) plus
...
[02-brief-board-review.md](../../../design/handoff/02-brief-board-review.md) went out the same day
...
`design/handoff/03-brief-cards-and-hands.md` asks for the card component, the dice hand (S4), the
...
**The handoff folder is committed with the brief.** `design/handoff/card-art-canvas/`
...
Spec 03 arrived as [03-spec-cards-and-hands.md](../../../design/handoff/03-spec-cards-and-hands.md)
...
five-item check in [design/README.md](../../../design/README.md) would have passed on a first
...
- **`scripts/extract-card-art.js` does the extraction, run by hand as `npm run assets:card-art`.** It
  parses `design/handoff/card-art-canvas/Card Art.dc.html` and writes one `.svg` per
  card into `src/ui/art/`. Not a build step: the artboard is a design source, and making `npm run build`
  parse HTML out of `design/` would put a design file in the production build's dependency graph.
...
| The design request | `design/handoff/05-brief-dice-pool-overlay.md`, D43 to D47 |
...
`design/handoff/00-open-requests.md`. Not a brief and not a spec, so it breaks the numbered-pair
...
and the handoff loop as [design/README.md](../../../design/README.md) describes it has no place to
...
- **What went out:** [06-brief-pawn-mark.md](../../../design/handoff/06-brief-pawn-mark.md), asking for
...
[07-brief-trap-marker.md](../../../design/handoff/07-brief-trap-marker.md), D51 to D60. The design loop
...
[03-spec-cards-and-hands.md](../../../design/handoff/03-spec-cards-and-hands.md): the skill square is a
...
stale stylesheets twice (handoff 16, the section above). `design/handoff/00-open-requests.md` is the
...
brief: [17-brief-last-card-and-pawn-status.md](../../../design/handoff/17-brief-last-card-and-pawn-status.md).
...
[17-spec-last-card-and-pawn-status.md](../../../design/handoff/17-spec-last-card-and-pawn-status.md)
...
[00-open-requests.md](../../../design/handoff/00-open-requests.md).** The card in the plate is a record
...
- **`lobby.css` is a placeholder built without a handoff**, on the `pool.css` precedent, and says so in
  ...
  status word. The brief is in `design/handoff/00-open-requests.md`.
...
- **`design/handoff/19-brief-online-lobby.md`, D116 to D122**, read against `272e36e`. The 2026-09-09
...
- **`src/ui/styles/lobby.css` is the delivered file, taken whole**, 283 lines after Prettier, and the
  spec is `design/handoff/19-spec-online-lobby.md`; `handoff-19/` is deleted as its README asks. No
