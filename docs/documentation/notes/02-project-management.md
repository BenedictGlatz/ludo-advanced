...
- Scrum, 3 sprints of 2 weeks, preceded by a 1-week Sprint 0 and followed by a 1-week buffer sprint:
  8 weeks total. Source: [one-pager.md](../../project-management/one-pager.md),
  [github-project.md](../../project-management/github-project.md).
...
- ~~**Contradiction, unresolved:**~~ [github-project.md](../../project-management/github-project.md)
...
- **Roles as practised, stated by Benedict Glatz on 2026-09-11 for the report.** No Scrum Master was ever
  ...
  team to them, the board and the backlog order within the Product Owner's priorities. His developer work
  ...
  his. Fabian Gemming kept final authority over mechanics, balancing and acceptance criteria as Product
  Owner, and also carried the design system and black-box regression testing. **This refines rather than
...
- **Five new risks entered the register**, all created by this plan rather than found in the codebase.
  ...
  [risk-analysis.md](../../project-management/risk-analysis.md).
...
- **Negative finding, found while placing #6:** the RACI matrix in
  [stakeholder-analysis.md](../../project-management/stakeholder-analysis.md) is an **empty
...
"Core gameplay and board MVP" sprint that [github-project.md](../../project-management/github-project.md)
...
- 2026-08-06: Documentation notes established under `docs/documentation/`. The report is written
...
- Risk register lives at
  [risk-analysis.md](../../project-management/risk-analysis.md): a 3×3 Likelihood×Impact
...
- **2026-08-10:** extended from 3 unrated-mitigation rows (Multiplayer, Complexity, Sickness) to 16,
  ...
  [github-project.md](../../project-management/github-project.md). Categories used: Schedule,
...
- Every row added on 2026-08-10 traces to a fact already recorded elsewhere in this repository (no
  speculative risks). See [risk-analysis.md](../../project-management/risk-analysis.md) for
...
- Which ceremonies actually take place, and whether they are minuted. Only one meeting note exists
  so far ([20260806.md](../../project-management/meeting-notes/2026-08-06.md), one sentence).
