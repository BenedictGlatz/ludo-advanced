...
the prose plan in [github-project.md](../project-management/github-project.md) gives a sprint a
...
[github-project.md](../project-management/github-project.md) instead, "Core gameplay and board
...
- 5 of the 13 board issues closed: #9 SMART analysis, #10 goal catalogue, #11 risk analysis (register
  ...
  analysis. All five are documents under `docs/project-management/`.
...
[github-project.md](../project-management/github-project.md). Kept because the report's planning
...
- **2026-08-29:** #26 board topology (5). `core/board.js`, the coordinate system everything else is
  computed on.
- **2026-08-29:** the first Claude Design handoff. `design/` and
...
- **2026-08-30:** #3 create design system (5). Five stylesheets in `src/ui/styles/` and the spec in
  `design/handoff/`. The five landing checks from the sprint plan were run before merging the
...
- **2026-08-30:** handoff 02 sent, `design/handoff/02-brief-board-review.md`, with nine numbered
...
- **2026-09-01:** #30 dice pool data model and selection logic (3), **closed as an audit rather than as
  ...
  `design/handoff/05-brief-dice-pool-overlay.md`, with five numbered decisions D43 to D47. The round
  is open. **The 3 points are booked in full**, and whether that is honest is the note below.
- **2026-09-01:** the work order `design/handoff/00-open-requests.md` sent, and **design handoff 04
...
- **2026-09-02:** the Sprint 2 closeout opened with a brief rather than with the board. Design brief 06
  (`design/handoff/06-brief-pawn-mark.md`, the seat shape on the pawn, closing D16 and NFR-12) went out
...
[risk-analysis.md](../project-management/risk-analysis.md), and lining candidates up is Sprint 2
